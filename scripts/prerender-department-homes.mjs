...
const pages = [
  ...
  {
    route: '/soins-dentaires-turquie', lang: 'fr', title: 'Soins dentaires en Turquie : implants, facettes et couronnes', siteName: 'Cliniqeo Dental',
    description: 'Préparez vos soins dentaires en Turquie avec un plan écrit : implants, facettes, couronnes, devis détaillé, organisation du séjour et suivi francophone.',
    body: `<main style="font-family:Arial,sans-serif;color:#243b53;line-height:1.7"><article style="max-width:1040px;margin:0 auto;padding:72px 24px"><h1>Soins dentaires en Turquie avec un plan clair et détaillé</h1><p>Comparez implants, facettes, couronnes et solutions de restauration avec un devis écrit, des responsabilités médicales identifiées et un accompagnement francophone.</p><h2>Des traitements étudiés après évaluation</h2><p>L’étude à distance fournit une première orientation. Le chirurgien-dentiste confirme le diagnostic et le plan définitif après l’examen clinique et l’imagerie nécessaires.</p><p><a href="/soins-dentaires-turquie#evaluation-dentaire">Demander une évaluation gratuite</a></p></article></main>`,
    alternates: [{ hreflang: 'fr', path: '/soins-dentaires-turquie' }, { hreflang: 'en', path: '/en/dental-treatment-turkey' }],
    schema: [organization, { '@context': 'https://schema.org', '@type': 'Service', name: 'Accompagnement pour soins dentaires en Turquie', url: `${origin}/soins-dentaires-turquie`, areaServed: 'France', provider: { '@id': `${origin}/#organization` } }],
  },
  {
